...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $newAlamat = $_POST['alamat'];
    ...
    $query = "UPDATE perusahaan SET nama_perusahaan='$newNama_perusahaan', email='$newEmail', contact='$newContact', alamat='$newAlamat' WHERE username='$username'";
...
<html lang="en">
    <head>
        <link rel="stylesheet" type="text/css" href="pbl-css/edit-profil-perusahaan.css"/>
