...
<body>
    ...
    <form action="simpan_kuisioner.php" method="POST" id="KuesionerLanjutan" align="left">
        ...
        <label for="Status">Apakah saat ini anda sedang bersekolah/kuliah?</label><br>
        ...
        <label for="Status2">Apakah  anda sedang atau pernah mengikuti pelatihan?</label><br>
        <input type="radio" id="Ya" name="q2" value="Ya">
        <label for="ya">Ya</label><br>
        <input type="radio" id="Tidak" name="q2" value="Tidak">
        <label for="Tidak">Tidak</label><br><br>

        <label for="Status3">Apa jenis pelatihan atau sertifikasi yang sedang atau pernah diikuti?</label>
