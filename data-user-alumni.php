...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="pbl-css/data-user_alumni.css"/>
        ...
        <div id="container">
            ...
            <table>
              ...
              include 'koneksi.php';
                ...
                <tr>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#show<?php echo $data['nik']; ?>"> <i class="fa-solid fa-eye"></i> Show </a></li>
                            <li><a class="dropdown-item" href="edit-user-alumni.php?nik=<?php echo $data['nik']; ?>"> <i class="fa-solid fa-pen-to-square"></i> Edit </a></li>
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['nik']; ?>"> <i class="fa-solid fa-trash"></i> Hapus </a></li>
                        </ul>
                        </div>
                    </td>
                <!-- Modal Show-->
                <div class="modal fade " id="show<?php echo $data['nik']?>" tabindex="-1"  aria-hidden="true">
                ...
                <!-- Modal hapus-->
                <div class="modal fade" id="hapus<?php echo $data['nik']?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        ...
                        Apakah anda yakin ingin menghapus data user alumni ini ?
                        <div class="modal-footer">
                            <a class="btn btn-danger" href="hapus_user_alumni.php?nik=<?= $data['nik'] ?>">HAPUS</a>
                        </form>
                        </div>
                    </div>
                </div>
