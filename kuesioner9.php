...
<header>
    ...
    <div id="Tabelkuisioner">
        <h3><center>Pendataan Kewirausahaan</center></h3>
        ...
        <label for="Usaha">Tahun memulai usaha</label><br>
        <input type="text" name="q1" id="q1"><br><br>

        

        <label for="Usaha2">Jenis usaha</label><br>
        <input type="radio" id="jasa" name="q2" value="Jasa">
        <label for="jasa">Jasa</label><br>
        <input type="radio" id="dagang" name="q2" value="Dagang">
        <label for="dagang">Dagang</label><br>
        <input type="radio" id="Manufaktur" name="q2" value="Manufaktur">
        <label for="Manufaktur">Manufaktur</label><br><br>
        <input type="radio" id="Option" name="q2" value="Lainnya">
        <label for="Option">Lainnya</label><br><br>
        <input type="text" name="q3" id="q3"><br><br>

        <label for="Usaha3">Nama usaha</label><br>
        <input type="text" name="q4" id="q4"><br><br>

        <label for="Usaha4">Alamat Usaha</label><br>
