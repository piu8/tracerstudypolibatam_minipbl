...
<html lang="en">
    <head>
        <link rel="stylesheet" type="text/css" href="pbl-css/export-data-riwayat-kerja.css"/>
        <title>Export</title>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div class="delete-container">
                ...
                <div class="confirmation-text">Export<br>Riwayat Kerja</div>
                <div class="button-container">
                    <button class="cancel-button"><a href="export-riwayat-kerja.php">Export</a></button>
                </div>
