...
<header>
    ...
    <div>
        <header>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door-fill" id="icon" viewBox="0 0 16 16">
    ...
    <div id="Tabelkuisioner">
        <h3><center>PENDATAAN KETENAGAKERJAAN</center></h3>
        <hr align=”left” color=”blue” size="1" ><br>
    
    <form action="simpan_kuisioner.php" method="POST" id="Sertifikasi" align="left">
        <input type="hidden" name="que" value="6">
        <input type="hidden" name="id_alumni" value="<?=$data['id']?>">

       

        <label for="Pekerjaan">Apakah saat ini Anda sudah bekerja?</label><br>
        <input type="radio" id="ya" name="q1" value="Sudah">
        <label for="ya">Sudah</label><br>
        <input type="radio" id="tidak" name="q1" value="Belum">
